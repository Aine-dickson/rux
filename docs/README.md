...
| [Rux next](./11-next.md) | *The direction decided 2026-09-26*: Rux's own checked language, generics, `async fn`, script modules, typed Rust exports, and the move off rhai to Rux's interpreter and Rust code generation. A plan, not a reference; nothing in it runs yet. |
