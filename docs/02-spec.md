...
> because [the rationale](./01-rationale.md), [the architecture](./04-architecture.md)
> and [the roadmap](./06-roadmap.md) all link into it.
>
> **If you are writing `.rux` code, you want [As Built](./05-as-built.md)** and
> [Script](./07-script.md). Those two are the reference: every name the editor
...
| the honored CSS subset | 97 properties, listed in [As Built](./05-as-built.md) |

Every rule here traces to a law in the [rationale](./01-rationale.md), and that
