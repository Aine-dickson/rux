...
pages=(
  ...
  "09-author-notes.md|contribute/author-notes.md|Author notes|7|Behaviour that is correct and still surprises, tracked with the page each one has to be explained on. Every entry is a v1.0 blocker."
)
