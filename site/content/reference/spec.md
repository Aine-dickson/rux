...
- `role="form"` → groups the fields inside it. A `<button type="submit">` or
  ...
  one fails. See [05, Forms](/reference/#forms).
...
Next: the [guide](https://github.com/Aine-dickson/rux/blob/main/docs/03-guide.md) builds a real screen using everything here.
