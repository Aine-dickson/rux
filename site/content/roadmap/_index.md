...
For *what works today*, read [05 — As Built](/reference/). This document is
...
between this code and [04 — Architecture](/contribute/).
...
The honored set is listed in [05 — As Built](/reference/). Everything else is
...
[04 — Architecture](/contribute/) always described — delete the category.
...
[01 — Rationale → Ephemeral UI state](/why/#ephemeral-ui-state-automatic-by-default-controllable-by-opt-in).
